...
public class Functions {
	...
	public static class group{
		...
		int id;
		int owner;
		public group(String name, int id, int owner){
			this.name = name;
			this.id = id;
			this.owner = owner;
		}
	 ...
	 * @param accept:对方是否同意好友请求
	 */
	public static void showAddFriendReply(String new_friend, boolean accept) {
	 ...
	 * @param profile:头像（若是群，则为null）
	 */
	public static void showNewChat(String name, int id, boolean is_group, ImageIcon profile) {
